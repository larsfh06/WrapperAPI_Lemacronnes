...
namespace WrapperAPI.Repositories.HotelRepositories
{
    public class HotelRepository : IHotelRepository
    {
        ...
        public HotelRepository(HttpClient httpClient, IConfiguration configuration)
        {
            ...
            _httpClient.BaseAddress = new Uri("https://app-lemarconnes-api-dev-z4b7skvxakgla.azurewebsites.net/");
        ...
        public BoekingResponseDTO CreateReservering(BoekingRequestDTO reservering)
        {
            ...
            throw new Exception($"Hotel API Error: {response.StatusCode} - Details: {errorBody}");
        }
        ...
        public void UpdateReservering(BoekingResponseDTO reservering)
        {
            ...
            if (!response.IsSuccessStatusCode)
            {
                throw new Exception("Update mislukt bij Hotel API");
            }
        }
        ...
        public void DeleteReservering(int id)
        {
            ...
            if (!response.IsSuccessStatusCode)
            {
                throw new Exception("Verwijderen mislukt bij Hotel API");
            }
        }
    }
}